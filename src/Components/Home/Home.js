  ...
  return (
    <div>
      ...
      <div className="mid-between">
        ...
        <div className="first" onClick={()=>navigate("/Login")}>Internet Banking</div> 
        <div className="Second" onClick={()=>navigate("/Location")}>Locate Us</div>
        <div className="Third">CALCULATOR</div>
        <div className="Fourth" onClick= {()=> navigate("/Contact")}>CONTACT US</div>
        </div>
      </div>
    </div>
    </div>
